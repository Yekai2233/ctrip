...
for i in room_id:
	...
	print(name)
	print(a)
	#print("create table %s (id int auto_increment primary key, time DATETIME, room_id varchar(20), area varchar(20), bed int, bname varchar(20), floor varchar(20), maxnum varchar(20), price int,foreign key(room_id) references ctriphangzhou(room_id))" %name)
